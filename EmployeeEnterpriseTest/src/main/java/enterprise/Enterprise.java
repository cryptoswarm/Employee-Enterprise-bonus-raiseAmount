    ...
    public  void readFileOfEmployees(){
        ...
        try {
            ...
            while (rd.ready()){
                ...
                anEmployee.setBonus(BonusSalaryRaise.getEmployeeBonus(bonusRate, currentSalary));
                anEmployee.setSalaryRaiseRate(BonusSalaryRaise.getRateSalaryRaise(echelon));
                anEmployee.setSalaryRaiseAmount(BonusSalaryRaise.getNewSalary(anEmployee.getSalaryRaiseRate(), currentSalary));
                anEmployee.setNewSalary(BonusSalaryRaise.getNewSalary(anEmployee.getSalaryRaiseRate(), currentSalary ));
